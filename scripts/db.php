...
class mysql {
	...
	private function whereIt( $field, $op = "", $value = array(), $aoo = "AND" ) {
	...
	public function where( $field, $op = "", $value = array() ) {
	...
	public function find_one( $params = array() ) {
		...
		return isset( $find[0] ) ? $find[0] : array();
	...
	public function update( $update, $query = "", $value = array() ) {
